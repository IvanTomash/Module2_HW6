...
namespace Homework_2_6
{
    ...
    /// Bakes bread.
    /// </summary>
    internal sealed class Toaster : IPowerCunsumer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Toaster"/> class.
        /// </summary>
        ...
        public Toaster(string name, double power, double amperage)
        {
            this.Name = name;
            this.Power = power;
        ...
        public double GetPowerConsumption(double time)
        {
